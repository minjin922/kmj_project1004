      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="userConfirm?user_id=${user_id }" class="block__16443 text-center d-block">
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="userResList?user_id=${user_id }" class="block__16443 text-center d-block">
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            <a href="userReview?user_id=${user_id }" class="block__16443 text-center d-block">
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="userQna?user_id=${user_id }" class="block__16443 text-center d-block">
          ...
          <div class="col-6 col-md-6 col-lg-4 mb-4 mb-lg-5">
            ...
            <a href="userLike?user_id=${user_id }" class="block__16443 text-center d-block">
